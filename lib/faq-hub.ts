...
export const FAQ_HUB: FaqCategory[] = [
  {
    ...
    faqs: [
      ...
      { q: "Does Go Moringa offer online diet consultation?", a: "Yes. Online consultation has been core to the practice for over a decade. The process — detailed assessment, a personalised written plan, and daily follow-ups — is identical to an in-clinic engagement and reaches clients anywhere in India or abroad." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How is a personalised plan different from a free diet chart online?", a: "A free chart is generic. A personalised plan is calibrated to your blood work, medical history, body composition and kitchen, and is revised continually against your real progress — that is what makes weight loss hold." },
