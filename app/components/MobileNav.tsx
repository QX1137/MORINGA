...
export function MobileNav() {
  ...
  return (
    <>
      {/* Labelled "MENU" button — a bare icon proved too easy to miss on
          mobile. The explicit label + border makes the nav unmistakable. */}
      <button
        type="button"
        onClick={() => setOpen(true)}
        className="lg:hidden inline-flex items-center gap-2 pl-3 pr-3.5 py-2 border border-ink/35 rounded-sm text-ink hover:bg-paper-dark transition"
      ...
      >
        ...
        <span className="text-sm font-medium uppercase tracking-[0.12em]">Menu</span>
      </button>
