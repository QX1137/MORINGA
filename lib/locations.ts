...
export const LOCATIONS: Record<string, LocationData> = {
  ...
  "best-dietitian-in-delhi-ncr": {
    slug: "best-dietitian-in-delhi-ncr",
    phpPath: "/best-dietitian-in-delhi-ncr",
    city: "Delhi NCR",
    title: "Best Dietitian in Delhi NCR",
    h1: "Best Dietitian in Delhi NCR",
    metaTitle: "Best Dietitian in Delhi NCR | Dt. Priyatama Srivastava, Go Moringa",
    metaDescription: "The best dietitian in Delhi NCR — Dt. Priyatama Srivastava of Go Moringa. 20 years' practice, 10,000+ clients across Gurgaon, Delhi, Noida, Faridabad & Ghaziabad. 5★ Practo.",
    heroSubhead: "One clinical practice for the whole National Capital Region — Gurgaon, Delhi, Noida, Faridabad and Ghaziabad — from the Sector 49 clinic and online.",
    heroImage: "/photography/clinic-reception.jpg",
    introLead: "Delhi NCR is one urban region with one shared health profile — and one of India's heaviest concentrations of lifestyle disease. For 20 years, Dt. Priyatama Srivastava has been the dietitian NCR turns to: a single clinical practice in Sector 49 Gurgaon, serving clients across Gurgaon, Delhi, Noida, Faridabad and Ghaziabad in-clinic and online, with the same assessment-plan-review process for every one of 10,000+ clients.",
    whyPickUs: [
    ...
    localContext: [
      { title: "The NCR corporate profile", body: "From Cyber City to Noida's tech sectors to Delhi's consulting firms, the NCR professional shares one pattern — sedentary 12-hour days, irregular dinners, weekend social eating, and lifestyle disease showing up early. Plans are built to work within that reality, not against it." },
      { title: "Women's hormonal health across NCR", body: "PCOS and thyroid disorders are strikingly common among NCR's young women, and too often left under-managed. The clinic's PCOS and thyroid protocols are among its most-booked programmes region-wide — addressing the hormonal mechanism, not just the weight." },
      { title: "Diabetes and cardiac risk in NCR's 40-plus", body: "The NCR professional in their 40s — desk job, family history, irregular meals — is the textbook case the clinic manages daily. Many reverse pre-diabetes outright; established type-2 diabetics commonly see HbA1c fall 1–2 points within a quarter of disciplined eating." },
      { title: "Wedding-season figure correction", body: "NCR's long wedding calendar makes pre-wedding figure correction a year-round programme. Brides and grooms across the region book six to twelve months ahead for a tested protocol covering figure correction, skin clarity through nutrition, and energy through the wedding week." },
    ],
    servesAreas: [
      "Gurgaon (Sector 49 clinic)",
      "South & West Delhi",
      "Central & East Delhi",
      "Noida & Greater Noida",
      "Faridabad & Ballabhgarh",
      "Ghaziabad & Indirapuram",
      "Manesar · Sohna · Dwarka",
      "Pan-NCR online consultation",
    ],
    travelDistance: "The Sector 49 Gurgaon clinic is central to NCR — and online consultation reaches every NCR city with identical clinical depth.",
    faqs: [
  ...
  "best-dietitian-in-india": {
    slug: "best-dietitian-in-india",
    phpPath: "/best-dietitian-in-india",
    city: "India",
    title: "Best Dietitian in India",
    h1: "Best Dietitian in India",
    metaTitle: "Best Dietitian in India | Online Diet Consultation | Go Moringa",
    metaDescription: "Among the best dietitians in India — Dt. Priyatama Srivastava of Go Moringa. 20 years' practice, 10,000+ clients, online diet consultation across every Indian state and for NRIs.",
    heroSubhead: "Online diet consultation across every Indian state — and for NRIs worldwide. Twenty years of clinical practice, delivered wherever you are.",
    ...
    localContext: [
      { title: "Why a national online practice works", body: "Nutrition counselling is an assessment, a written plan and a structured review — all of which travel perfectly over video and WhatsApp. Quality clinical dietitians with two decades of experience are concentrated in a few metros; online consultation removes that geography problem entirely for clients anywhere in India." },
      { title: "Tier-2 and tier-3 India", body: "A large and growing share of clients are in tier-2 and tier-3 towns where specialised clinical-nutrition care is genuinely hard to find locally. For them, an online consultation with a 20-year practice is not a compromise — it is the best option available." },
      { title: "The conditions, nationwide", body: "Weight loss and gain, PCOS/PCOD, diabetes, thyroid, cholesterol, blood pressure, fatty liver, pregnancy and post-partum nutrition, and therapeutic diets for chronic and recovery conditions — managed for clients across every Indian state." },
    ],
    servesAreas: [
      "Delhi NCR · Mumbai · Bengaluru",
      "Hyderabad · Chennai · Pune",
      "Kolkata · Ahmedabad · Jaipur",
      "Chandigarh · Lucknow · Indore",
      "All Indian states & union territories",
      "NRI clients — Gulf, UK, US, Australia",
      "Online video & WhatsApp consultation",
    ],
